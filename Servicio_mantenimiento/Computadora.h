...
namespace Serviciomantenimiento {
	...
	/// <summary>
	/// Resumen de Computadora
	/// </summary>
	public ref class Computadora : public System::Windows::Forms::Form
	{
	public:
		Computadora(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Computadora::typeid));
			...
			this->panel4->Location = System::Drawing::Point(508, 3);
			...
			this->button3->Location = System::Drawing::Point(538, 5);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(124, 21);
			this->button3->TabIndex = 26;
			this->button3->Text = L"Registrar producto";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &Computadora::button3_Click);
			// 
			// panel3
			// 
			...
			this->label2->Location = System::Drawing::Point(244, 21);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(266, 42);
			this->label2->TabIndex = 15;
			this->label2->Text = L"PRODUCTOS";
			this->label2->Click += gcnew System::EventHandler(this, &Computadora::label2_Click);
			// 
			// panel2
			// 
...
#pragma endregion
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		registrar_producto^ form = gcnew registrar_producto();
		form->ShowDialog();
	}
